...
class PlotlyPlotter(metaclass=bt.MetaParams):
    params = (
        ('scheme', PlotScheme()),
        ('show', True),
    )
    ...
    def plot(self, strategy, figid=0, numfigs=1, iplot=True, start=None, end=None, **kwargs):
        ...
        figs = []
        row_heights = [300] * self.pinf.nrows
        row_heights[self.volume_fig_idx] = 800
